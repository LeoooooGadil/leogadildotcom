...
const BlogCard = ({ picturecolor, title, description, readTime, datepublished }: BlogPostProps) => {
	return (
		<div className='flex justify-left gap-6 p-3 h-48 rounded-2xl drop-shadow-lg w-full max-w-[576px] lg:w-max hover:bg-[--color-dark-accent] transition-colors cursor-pointer'>
