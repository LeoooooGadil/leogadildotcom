...
const ToolComponent = ({ title, description, image, className, link }: ToolProps) => {
	return (
		...
		>
			<div>
				<div className={`h-16 w-16 bg-[--color-light] drop-shadow-lg rounded-2xl flex items-center justify-center ${className} group-hover:rotate-0 transition-all duration-300`}>
					<Image
						src={image.src}
						alt={title}
